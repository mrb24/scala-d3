define(['require', './Node', './NodeList', './Element', './Text', './Comment', './Event', './DocumentFragment',
        './ProcessingInstruction', './FilteredElementList', './TreeWalker', './NodeFilter', './URL', './select',
        './events', './xmlnames', './htmlelts', './utils', './MutationConstants', './SVGElement',
        './DOMImplementation'],
function(require, Node, NodeList, Element, Text, Comment, Event, DocumentFragment,
        ProcessingInstruction, FilteredElementList, TreeWalker, NodeFilter, URL, select,
        events, xml, html, utils, MUTATE, SVGElement) {
  ...
  createElementNS: { value: function(namespace, qualifiedName) {
    ...
    if (namespace === NAMESPACE.HTML) {
      return html.createElement(this, localName, prefix);
        ...
        return new SVGElement(this, localName, namespace, prefix);
    }
